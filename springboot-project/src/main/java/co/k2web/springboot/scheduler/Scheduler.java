...
public class Scheduler {
    ...
    public void scheduler() {
        ...
        File userRequestFile = requestService.createFile(Constants.USER_REQUEST_CHECKING_AND_COUNT_FILE_PATH);
    ...
    public static LinkedHashMap<String, String> getListUserRequestFromTextFile() {
        LinkedHashMap<String, String> listUser = new LinkedHashMap<>();
        BufferedReader br = null;

        try {
            String filePath = Constants.USER_REQUEST_LOG_FILE_PATH;
